...
{
    public class InterfazNucleo//Fachada principal del nucleo programa que nos permite usar las funciones del programa sin dar a conocer como funcionan por dentro
    {
        ...
        public InterfazNucleo()//Constructor de la clase
        {
        }
        ...
        public UsuarioSimple ObtenerUsuarioPorNombreOMail(string pNombreUsuario)
            //Nos permite obtener un usuario simple de la base de datos a partir del nombreUsuario del usuario
        {
            return interfazDAL.ObtenerUsuarioPorNombreOMail(pNombreUsuario);
        }
        ...
        public void ActualizarEjemplar(string idLibro, string estado)
            //Permite actualizar la informacion de un ejemplar
        {
            interfazDAL.ActualizarEjemplar(idLibro, estado);
        }
        public Ejemplar ObtenerEjemplar(int id)
            //Permite obtener un ejemplar de la base de datos a partir del id del mismo
        {
        ...
        public Libro ObtenerLibroDeEjemplar(int id)
            //Permite obtener el libro de un ejemplar a partir del id del ejemplar
        {
        ...
        public Libro ObtenerLibroDePrestamo(int id)
            //Permite obtener el libro de un prestamo a partir del id del prestamo
        {
            return interfazDAL.ObtenerLibroDePrestamo(id);
        }
        public Ejemplar ObtenerEjemplarDePrestamo(int id)
           //Permite obtener el ejemplar de un prestamo a partir del id del prestamo  
        {
        ...
        public IEnumerable<Ejemplar> ObtenerEjemplares()
            //permite obtener la lista total de ejemplares
        ...
        //devuelve el id del ultimo ejemplar registrado
        ...
        public void RegistrarLog(string sLog)//Permite registrar un nuevo log en la bitacora
        {
            ...
            ArchivoDeLog oLog = new ArchivoDeLog();//abrimos o creamos el archivo en caso de no existir
