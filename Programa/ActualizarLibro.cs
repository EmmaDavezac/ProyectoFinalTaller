...
/// </summary>
    public partial class ActualizarLibro : Form
    {
        ...
        /// <summary>
        /// Resumen:Varible que nos permite guardar las sumatoria de ejemplares que se esta agregando o restando.
        /// </summary>
        ...
        /// <summary>
        /// Resumen: Elimina el contenido de los textbox cuando se presiona el buttonDeshacerCambios
        /// </summary>
        ...
        private void buttonGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ((GestionDeLibros)this.Owner).ObtenerLibros();
                this.Owner.Show();
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// Resumen:Accion que se ejecuta cuando se presiona el buttonBusquedaAvanzada,  Botton que nos permite ir al buscador por medio de la api libros, permitiendonos modificar de manera mas rapida el libro.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Resumen:Se encarga traer los datos actualizados de la ventana del metodo anterior.

        /// </summary>
        /// <param name="pTitulo"></param>
        /// <param name="pAutor"></param>
        /// <param name="pAñoPublicacion"></param>
        ...
        /// <summary>
        /// Resumen: Se encarga de cargar los datos del libro en la ventana actual.
        /// </summary>
        /// <param name="pISBN"></param>
        /// <param name="pTitulo"></param>
        /// <param name="pAutor"></param>
        ...
        public void InicializarLibro(string pISBN, string pTitulo, string pAutor, string pAñoPublicacion, string pBaja)
        {
            try
            {
                textBoxTitulo.Text = pTitulo;
        ...
        /// <summary>
        /// Resumen:Accion que se ejecuta cuando se presiona el burronAñadirEjemplares
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Resumen:Accion que se ejecuta cuando se presiona el burronEliminarEjemplares
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
