        ...
        public void ObtenerPrestamos()
        {
            ...
            foreach (var item in prestamos)
            {
                if (item.FechaDevolucion == null)
                {
                    ...
                    dataGridViewPrestamos.Rows[n].Cells[3].Value = item.TituloLibro;
                    dataGridViewPrestamos.Rows[n].Cells[4].Value = item.ISBNLibro;
        ...
        private void dataGridViewPrestamos_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell.Value.ToString() == "Devolucion")
                {
                    ...
                    UsuarioSimple usuarioSimple = interfazNucleo.ObtenerUsuarioPorNombreOMail(usuario);
