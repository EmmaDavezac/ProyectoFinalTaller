...
namespace Presentacion
{
    ...
    {
        /// <summary>
        /// Resumen:Instancia de la fachada del nucleo para realizar operaciones dentro del dominio
        /// </summary>
        ...
        /// <summary>
        /// Resumen: Accion que se ejecuta cuando se presiona el boton volver
        /// </summary>
        ...
        /// <summary>
        /// Resumen: Accion que se ejecuta cuando se presiona el boton Guardar
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
                            ...
                            if (DateTime.Now.Year - dateTimePickerFechaNacimiento.Value.Date.Year >= 18 && DateTime.Now.Year - dateTimePickerFechaNacimiento.Value.Date.Year <= 120)//Verifica que la edad del administrador este entre los 18 y 120 años
                            {
                                if (!string.IsNullOrEmpty(textBoxMail.Text) && UtilidadesPresentacion.EsUnEmailValido(textBoxMail.Text))//Verifica que el mail no este vacio y que sea un mail en un formato valido.
                                {
                                    if (!string.IsNullOrEmpty(textBoxTelefono.Text) && textBoxTelefono.Text.All(Char.IsDigit) && textBoxTelefono.Text.Length >= 8 && textBoxTelefono.Text.Length <= 11)//Verifica que el numero de telefono no este vacio, que todos sus valores sean digitos, y que su longitud este entre 8 y 11 digitos.
                                    {
                                        ...
                                        ((GestionDeAdministradores)Owner).ObtenerAdministradores();//Actualiza el listado de administradores de su owner
        ...
        private void buttonModificarContraseña_Click(object sender, EventArgs e)
        {
            try
            {
                ModificacionDeContraseñaDeAdministrador ventana = new ModificacionDeContraseñaDeAdministrador(textBoxNombreUsuario.Text);
        ...
        /// <summary>
        /// Resumen: Accion que se ejecuta cuando se modifica el checkbox que nos permite dar de baja o alta a un administrador
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
